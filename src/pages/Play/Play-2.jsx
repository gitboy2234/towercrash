...
function Play() {
    ...
    const [counter,
        setCounter] = useState();
    const [gameCounter,
        setGameCounter] = useState(1);
    const [speedCounter,
        setSpeedCounter] = useState(1)
    ...
    return (
        <div
            className="grid grid-cols-1 grid-rows-2  border-2 text-center h-full overflow-y-auto">
            <div>
                <div
                    className={showCrash
                    ? 'w-full h-10 bg-green-600 my-4'
                    : 'hidden'}>
                    <span
                        className={showCrash
                        ? ' text-3xl my-auto '
                        : 'hidden'}>Game Starting on {counter}</span>
                </div>
                <span
                    className={showCrash
                    ? 'hidden'
                    : ' text-9xl'}>{gameCounter}x
                </span>
            ...
            <div className="grid xl:grid-cols-2 border-2 h-full">
                <div className=" border-r-2 sm:border-b-2 rounded-md pt-5 sm:pb-10 lg">
                    ...
                    <form className="pt-2 text-black">
                        ...
                        <span className=" bg-slate-700 py-2.5 px-3 text-white rounded-lg mr-6 ml-2">X</span>
                    </form>
                    <div className="pt-10">
                        <button
                            ...
                            type="submit">Take Profit</button>
                    </div>
                </div>
                <div
                    className="border-r-2 sm:border-b-2 rounded-md overflow-y-auto pb-2 px-2 text-black">
                    {!showChat
                        ? (
                            <div className="joinChatContainer">
                                ...
                                <button
                                    className='text-white hover:scale-125 hover:text-red-700   ease-in-out '
